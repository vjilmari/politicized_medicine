...
```
## 
##                NN     Used_CAM_ONLY Used_conv_and_CAM 
##              6877               503              5100 
##    Used_conv_ONLY              <NA> 
##             27705                 0
```
...
## 
##                NN     Used_CAM_ONLY Used_conv_and_CAM 
##        0.14651321        0.01073232        0.13155594 
##    Used_conv_ONLY              <NA> 
##        0.71119852        0.00000000
```
...
```
## Warning in cor(x, use = use, method = method): the standard
## deviation is zero
```
...
```
##                      gndr.c age10.c edu.ord income.ord
## gndr.c                 1.00    0.04   -0.04      -0.11
## age10.c                0.04    1.00   -0.32      -0.23
## edu.ord               -0.04   -0.32    1.00       0.41
## income.ord            -0.11   -0.23    0.41       1.00
## income.missing          NaN     NaN     NaN        NaN
## strain.on.health.c     0.12    0.16   -0.12      -0.16
## lrgen.z               -0.03    0.04   -0.06       0.04
## lrecon.z              -0.03    0.05    0.01       0.09
## galtan.z              -0.03    0.09   -0.12      -0.02
## antielite_salience.z  -0.04   -0.10   -0.05      -0.10
## corrupt_salience.z    -0.02   -0.11   -0.01      -0.07
##                      income.missing strain.on.health.c lrgen.z
## gndr.c                          NaN               0.12   -0.03
## age10.c                         NaN               0.16    0.04
## edu.ord                         NaN              -0.12   -0.06
## income.ord                      NaN              -0.16    0.04
## income.missing                  NaN                NaN     NaN
## strain.on.health.c              NaN               1.00   -0.02
## lrgen.z                         NaN              -0.02    1.00
## lrecon.z                        NaN              -0.03    0.85
## galtan.z                        NaN               0.00    0.82
## antielite_salience.z            NaN               0.02    0.08
## corrupt_salience.z              NaN               0.01    0.00
##                      lrecon.z galtan.z antielite_salience.z
## gndr.c                  -0.03    -0.03                -0.04
## age10.c                  0.05     0.09                -0.10
## edu.ord                  0.01    -0.12                -0.05
## income.ord               0.09    -0.02                -0.10
## income.missing            NaN      NaN                  NaN
## strain.on.health.c      -0.03     0.00                 0.02
## lrgen.z                  0.85     0.82                 0.08
## lrecon.z                 1.00     0.59                -0.25
## galtan.z                 0.59     1.00                 0.21
## antielite_salience.z    -0.25     0.21                 1.00
## corrupt_salience.z      -0.28    -0.06                 0.77
##                      corrupt_salience.z
## gndr.c                            -0.02
## age10.c                           -0.11
## edu.ord                           -0.01
## income.ord                        -0.07
## income.missing                      NaN
## strain.on.health.c                 0.01
## lrgen.z                            0.00
## lrecon.z                          -0.28
## galtan.z                          -0.06
## antielite_salience.z               0.77
## corrupt_salience.z                 1.00
```
...
```
##                      gndr.c age10.c edu.ord income.ord
## gndr.c                0.000       0   0.000      0.000
## age10.c               0.000       0   0.000      0.000
## edu.ord               0.000       0     NaN      0.000
## income.ord            0.000       0   0.000      0.000
## income.missing          NaN     NaN     NaN        NaN
## strain.on.health.c    0.000       0   0.000      0.000
## lrgen.z               0.000       0   0.000      0.000
## lrecon.z              0.001       0   0.436      0.000
## galtan.z              0.000       0   0.000      0.001
## antielite_salience.z  0.000       0   0.000      0.000
## corrupt_salience.z    0.006       0   0.159      0.000
##                      income.missing strain.on.health.c lrgen.z
## gndr.c                          NaN              0.000   0.000
## age10.c                         NaN              0.000   0.000
## edu.ord                         NaN              0.000   0.000
## income.ord                      NaN              0.000   0.000
## income.missing                  NaN                NaN     NaN
## strain.on.health.c              NaN              0.000   0.001
## lrgen.z                         NaN              0.001     NaN
## lrecon.z                        NaN              0.000   0.000
## galtan.z                        NaN              0.563   0.000
## antielite_salience.z            NaN              0.012   0.000
## corrupt_salience.z              NaN              0.489   0.797
##                      lrecon.z galtan.z antielite_salience.z
## gndr.c                  0.001    0.000                0.000
## age10.c                 0.000    0.000                0.000
## edu.ord                 0.436    0.000                0.000
## income.ord              0.000    0.001                0.000
## income.missing            NaN      NaN                  NaN
## strain.on.health.c      0.000    0.563                0.012
## lrgen.z                 0.000    0.000                0.000
## lrecon.z                  NaN    0.000                0.000
## galtan.z                0.000    0.000                0.000
## antielite_salience.z    0.000    0.000                0.000
## corrupt_salience.z      0.000    0.000                0.000
##                      corrupt_salience.z
## gndr.c                            0.006
## age10.c                           0.000
## edu.ord                           0.159
## income.ord                        0.000
## income.missing                      NaN
## strain.on.health.c                0.489
## lrgen.z                           0.797
## lrecon.z                          0.000
## galtan.z                          0.000
## antielite_salience.z              0.000
## corrupt_salience.z                  NaN
```
...
##  [1] Hmisc_4.6-0     ggplot2_3.3.5   Formula_1.2-4  
##  [4] survival_3.2-13 lattice_0.20-45 psych_2.1.9    
##  [7] rio_0.5.29      dplyr_1.0.7     knitr_1.37     
## [10] rmarkdown_2.11  devtools_2.4.3  usethis_2.0.1  
## 
